...
use TestApp\Entity\Api\ApplicationInfo;
use TestApp\Entity\User;

class TestAppRestController extends AbstractFOSRestController
{
    ...
    {
        $version = $this->getParameter('testapp.version');
     ...
     * @Operation(
     *     tags={"Information"},
     *     summary="Retrieve information about the running testapp application.",
     *     @OA\Response(
     *         response="200",
     *         description="Returned when successful",
    ...
    public function getInfoAction(Config $craueConfig)
    {
        $info = new ApplicationInfo(
            $this->getParameter('testapp.version'),
