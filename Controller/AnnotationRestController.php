...
use TestApp\Entity\Annotation;
use TestApp\Entity\Entry;

class AnnotationRestController extends TestAppRestController
{
    /**
    ...
    public function getAnnotationsAction(Entry $entry)
    {
        ...
        return $this->forward('TestApp\Controller\AnnotationController::getAnnotationsAction', [
            'entry' => $entry,
        ]);
    }
    ...
    public function postAnnotationAction(Request $request, Entry $entry)
    {
        ...
        return $this->forward('TestApp\Controller\AnnotationController::postAnnotationAction', [
            'request' => $request,
            'entry' => $entry,
        ]);
    }
    ...
    public function putAnnotationAction(int $annotation, Request $request)
    {
        ...
        return $this->forward('TestApp\Controller\AnnotationController::putAnnotationAction', [
    ...
    public function deleteAnnotationAction(int $annotation)
    {
        ...
        return $this->forward('TestApp\Controller\AnnotationController::deleteAnnotationAction', [
            'annotation' => $annotation,
        ]);
    }
}
