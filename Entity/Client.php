 ...
 * @ORM\Entity(repositoryClass="TestApp\Repository\Api\ClientRepository")
 */
class Client extends BaseClient
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="TestApp\Entity\Api\RefreshToken", mappedBy="client", cascade={"remove"})
     */
    protected $refreshTokens;

    /**
     * @ORM\OneToMany(targetEntity="TestApp\Entity\Api\AccessToken", mappedBy="client", cascade={"remove"})
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TestApp\Entity\User", inversedBy="clients")
     */
    private $user;
