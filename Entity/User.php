 ...
 *
 * @XmlRoot("user")
 * @ORM\Entity(repositoryClass="TestApp\Repository\UserRepository")
 * @ORM\Table(name="`user`")
...
class User extends BaseUser implements EmailTwoFactorInterface, GoogleTwoFactorInterface, BackupCodeInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="TestApp\Entity\Entry", mappedBy="user", cascade={"remove"})
     */
    protected $entries;

    /**
     * @ORM\OneToOne(targetEntity="TestApp\Entity\Config", mappedBy="user", cascade={"remove"})
     */
    protected $config;

    /**
     * @var ArrayCollection&iterable<\TestApp\Entity\SiteCredential>
     *
     * @ORM\OneToMany(targetEntity="TestApp\Entity\SiteCredential", mappedBy="user", cascade={"remove"})
     */
    protected $siteCredentials;

    /**
     * @var ArrayCollection&iterable<\TestApp\Entity\Api\Client>
     *
     * @ORM\OneToMany(targetEntity="TestApp\Entity\Api\Client", mappedBy="user", cascade={"remove"})
     */
    protected $clients;
