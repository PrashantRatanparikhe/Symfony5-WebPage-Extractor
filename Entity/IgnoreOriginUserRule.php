 ...
 * Ignore Origin rule.
 *
 * @ORM\Entity(repositoryClass="TestApp\Repository\IgnoreOriginUserRuleRepository")
...
class IgnoreOriginUserRule implements IgnoreOriginRuleInterface, RuleInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="TestApp\Entity\Config", inversedBy="ignoreOriginRules")
